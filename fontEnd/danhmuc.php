...
<div class="container"> 
    ...
    <div>
        ...
        $offset = ($page - 1) *5;
        $stmt = $conn ->query("select * from sanpham limit 5 offset " . $offset);
        ...
        <tr>
            <td data-th="Product"> 
                <div class="row"> 
                    <div class="col-sm-2 hidden-xs"><img src="../<?php echo $row['4']?>" alt="Sản phẩm 1" class="img-responsive" width="100"></div> 
                    <div class="col-sm-10"> 
            ...
            <td data-th="Subtotal" class="text-center"><?php echo $row['3'] ?></td> 
            <td class="actions" data-th="">
                <a href="./suasanpham.php?id=<?php echo $row['0'] ?>"><button class="btn btn-info btn-sm">Sửa</i></button></a> 
                <a href="../backEnd/xoa.php?id=<?php echo $row['0'] ?>"><button class="btn btn-danger btn-sm">Xóa</i></button></a>
            </td>
        </tr>
        <?php
        }
