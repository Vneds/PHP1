...
<div class="container"> 
    ...
    <thead> 
        <tr> 
            ...
            <th style="width:18%" class="text-center">Phương thức</th> 
    ...
    <div>
        ...
        $offset = ($page - 1) *5;
        $stmt = $conn ->query("select * from donhang limit 5 offset " . $offset);
        ...
        <tr>
            <td data-th="Product"> 
                <div class="row"> 
                    <div class="col-sm-2 hidden-xs"><?php echo $row['0']?></div> 
                    <div class="col-sm-10"> 
            ...
            <td data-th="Price"><?php echo $row['4'] ?></td>
            <td data-th="Price"><?php echo $row['2'] ?></td>
            <td data-th="Price"><?php echo $row['3'] ?></td>
            <td data-th="Price"><?php echo $row['5'] ?></td> 
            <td data-th="Quantity"><?php echo $row['6']?></td> 
            <td data-th="Subtotal" class="text-center" id="name"><?php echo $row['1'] ?></td>                                   
            <td class="actions" data-th="">
                <a href="./suaAdmin_user.php?id=<?php echo $row['0'] ?>"><button class="btn btn-info btn-sm">Duyệt</i></button></a> 
