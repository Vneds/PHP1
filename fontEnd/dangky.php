    ...
    <div class="swapper">
        <div class="container">
            <header class="col-12 col-sm-12">
                ...
                <hr>
                <p class="home">HOMEPAGE/Become a member</p>
            </header>
            ...
            <div class="col-12 dangky">
                <div class="singin">
                    ...
                    <form action="../backEnd/dangky.php" method ="post">
                        ...
                        <input name="email" type="email" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" id="email" required>
                        <p>Name <label for="">*</label></p>
                        <input type="text" placeholder="" id="input3" name="user">
                        <p>Create a password <label for="">*</label></p>
                        ...
                        <p>Date of birth <label for="">*</label></p>
                        <input type="date" name="date" id="input2">
                        <input type="submit" id="but1" value="Become a menber">
                    </form>
                    <a href="http://localhost/PHP/33-PS25766-L%C3%AA%20Qu%E1%BB%91c%20Vi%E1%BB%87t-Assgnment/fontEnd/dangnhap.php"><u>Back to sign in</u></a>
                </div>
            </div>
        </div>
