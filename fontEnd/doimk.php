        ...
        <div class="container">
            ...
            <div class="col-12 dangky">
                <div class="singin">
                    ...
                    <form action="../backEnd/doimk.php" method ="post">
                        <p>Pass <label for="">*</label></p>
                        <input name="pass" type="pass"id="email" required>
                        <p>Pass new<label for="">*</label></p>
                        <input type="pass" name="newpass" id="input2">
