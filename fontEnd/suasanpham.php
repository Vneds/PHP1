...
<body>
    ...
    <div class="col-12 dangky">
                <div class="singin">
                    <form action="../backEnd/capnhat.php?id=<?php echo $kq['id']?>" method ="post" enctype="multipart/form-data">
                        <p>Name <label for="">*</label></p>
                        <input name="name" type="name" id="email" required value="<?php echo $kq['name']?>">
                        <p>Price <label for="">*</label></p>
                        <input type="text" placeholder="" id="input3" name="price" value="<?php echo $kq['price']?>">
                        <p>Type <label for="">*</label></p>
                        <select name="type" id="input1" value="<?php echo $kq['type']?>">
                          <option value="Quần áo">Quần áo</option>
                          <option value="Chăn gối">Chăn gối</option>
                          <option value="Giầy dep">Giầy dép</option>
                        </select>
